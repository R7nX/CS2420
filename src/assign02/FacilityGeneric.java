...
public class FacilityGeneric<Type> {
    ...
    public ArrayList<CurrentPatientGeneric<Type>> lookupByPhysician(Type physician) {
        ArrayList<CurrentPatientGeneric<Type>> physicianPatient = new ArrayList<>();

        for (CurrentPatientGeneric<Type> patient : patientList) {
            if (patient.getPhysician().equals(physician)) {
                physicianPatient.add(patient);
            }
        }
    ...
    protected class OrderByName implements Comparator<CurrentPatientGeneric<Type>> {
        public int compare(CurrentPatientGeneric<Type> patient1, CurrentPatientGeneric<Type> patient2) {
            ...
            int lastNameComparison = patient1.getLastName().compareTo(patient2.getLastName());
            if (lastNameComparison != 0) {
                return lastNameComparison;
            }


            int firstNameComparison = patient1.getFirstName().compareTo(patient2.getFirstName());
